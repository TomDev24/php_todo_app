...
<footer class="main-footer">
	...
	<a class="main-footer__button button button--plus" href="<?php echo SITE_ROOT . '/pages/form-task.php' ?>">Добавить задачу</a>
        ...
        <div class="main-footer__developed-by">
	    	...
	    	<img src="<?php echo SITE_ROOT.'/img/htmlacademy.svg'; ?>" alt="HTML Academy" width="118" height="40">
            </a>
        </div>
    </div>
</footer>
